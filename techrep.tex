...
\def\pagecontents{\ifvoid\margin_ins\else % marginal info is present
  ...
  \ifdim\fig_left>0pt
    \global\advance\fig_left by -\ht\fig_ins
    \global\advance\fig_left by -\dp\fig_ins
    \unvbox\fig_ins
    \bigskip
  \fi
  \ifdim\tab_left>0pt
    \global\advance\tab_left by -\ht\tab_ins
    \global\advance\tab_left by -\dp\tab_ins
    \unvbox\tab_ins
    \bigskip
  \fi
...
\def\endCaption{\egroup
  ...
  \ifdim\wd\cap_box>\dimen_one
    \vbox{\setbox\box_one=\hbox{\bf\cap_label.\space}%
