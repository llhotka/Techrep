...
\newcount\text_lno % line counter for text paragraphs
...
\font\x_euex=euex10
\font\x_tt="\mono_fam"
\font\x_tti="\mono_fam/I"
\font\x_ttb="\mono_fam/B"
\font\x_ttib="\mono_fam/IB"
\font\x_sy=cmsy10
...
\font\ix_eubf=eurb9
\font\ix_euex=euex9
\font\ix_tt="\mono_fam" at 9pt
\font\ix_tti="\mono_fam/I" at 9pt
\font\ix_ttb="\mono_fam/B" at 9pt
\font\ix_ttib="\mono_fam/IB" at 9pt
\font\ix_sy=cmsy9
...
\font\xii_tt="\mono_fam" at 12pt
\font\xii_tti="\mono_fam/I" at 12pt
\font\xii_ttb="\mono_fam/B" at 12pt
\font\xii_ttib="\mono_fam/IB" at 12pt
...
\font\xiv_tt="\mono_fam" at 14pt
\font\xiv_tti="\mono_fam/I" at 14pt
\font\xiv_ttb="\mono_fam/B" at 14pt
\font\xiv_ttib="\mono_fam/IB" at 14pt
...
\font\xvii_tt="\mono_fam" at 17pt
\font\xvii_tti="\mono_fam/I" at 17pt
\font\xvii_ttb="\mono_fam/B" at 17pt
\font\xvii_ttib="\mono_fam/IB" at 17pt
...
\font\xxi_tt="\mono_fam" at 21pt
\font\xxi_tti="\mono_fam/I" at 21pt
\font\xxi_ttb="\mono_fam/B" at 21pt
\font\xxi_ttib="\mono_fam/IB" at 21pt
...
\def\set_line_sizes#1#2#3{\normalbaselineskip=#1%
  ...
  \divide\dimen_one by 13
  \setbox\strutbox=\hbox{\vrule height 10\dimen_one
    depth 3\dimen_one width 0pt}%
  \setbox\vlinebox=\hbox{\vrule height 10\dimen_one
    depth 3\dimen_one}%
  \smallskipamount=3\dimen_one plus\dimen_one minus\dimen_one
  \medskipamount=6\dimen_one plus2\dimen_one minus2\dimen_one
  \bigskipamount=12\dimen_one plus4\dimen_one minus4\dimen_one}
...
\def\makeTitle{\edef\the_title{\the\titl@}
    \leftRunHead={{\x_i\folio}\kern2em\ifnum\auth_count>3
...
\def\endAbstract{\endTextNum\egroup\vskip\belowabs_skip}
...
\def\numberedVerbatim{\par\begingroup\tt
  ...
  \everypar{\advance\verb_lno by1 \llap{\sevenrm\the\verb_lno\ \ }}}
...
\def\begin_list{\par\goodbreak\vskip\list_skip\bgroup
    \advance\leftskip by \item_indent \first_itemtrue}

\def\endList{\endTextNum\egroup\vskip\list_skip}

\def\list_item{\iffirst_item \par\first_itemfalse
  \else \endTextNum\goodbreak
...
\def\image_[#1]#2{\def\pris{#1}%
    \centerline{\XeTeXpicfile "#2"\ifx\pris\empty\else
        width #1\hsize\fi}}
...
% Line numbering
\text_lno=0
\def\beginTextNum{\par\begingroup
  \def\par{\ifhmode\complete_par\fi}%
  \setbox\para_box=\vbox\bgroup}
\def\endTextNum{\par\egroup\endgroup}
\def\complete_par{\endgraf \global\advance\text_lno by \prevgraf
  \count_one=\text_lno \setbox0=\hbox{}
  \loop \unskip \unpenalty \setbox2=\lastbox
    \ifhbox2 \global\setbox0=
        \hbox{\hbox to-\leftskip{\hskip-\leftskip\hss
                                 $\scriptstyle\number\count_one.$%
                                 \hskip.7em}%
