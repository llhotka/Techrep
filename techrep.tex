...
\def\image_[#1]#2{\def\pris{#1}%
  \ifx\pris\empty
    \setbox\fig_box=\hbox{\XeTeXpicfile "#2"\relax}%
    \ifdim\wd\fig_box>\hsize
      \centerline{\XeTeXpicfile "#2" width \hsize}%
    \else\ifdim\ht\fig_box>\vsize
      \centerline{\XeTeXpicfile "#2" height \vsize}%
    \else
      \centerline{\unhbox\fig_box}%
    \fi\fi
  \else
    \centerline{\XeTeXpicfile "#2" width #1\hsize}%
  \fi}
